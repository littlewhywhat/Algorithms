...
public class TestAnswersCakedDivider {
	...
	public static final String[] BIG_ANSWERS = new String[] { "250 -250", "45" };
	public static final String[] CUSTOM_THREE_ANSWERS = new String[] { "1 5", "45" };
}
